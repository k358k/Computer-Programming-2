...
public class GUIMS1_try {
	...
	/*ImageIcon i = new ImageIcon("m.jpg");
	Border b = BorderFactory.createLineBorder(Color.black,3);
	
	JLabel l = new JLabel();// creates a label
	l.setText("Enter"); // sets text on the label
	l.setIcon(i);// adds the icon on the label
	l.setHorizontalTextPosition(JLabel.RIGHT);
	l.setVerticalTextPosition(JLabel.CENTER);		
	//	l.setVerticalAlignment(JLabel.CENTER);
	l.setForeground(new Color(0,0, 5));
	l.setFont(new Font("Broadway",Font.PLAIN,40));*/
...
//	f.getContentPane().setBackground(new Color(120,50,250)); // sets the color of the background
											// red, green, blue
